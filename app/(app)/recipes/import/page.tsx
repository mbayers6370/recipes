...
const S: Record<string, React.CSSProperties> = {
  ...
  title: { fontSize: 22, fontWeight: 700, fontFamily: "var(--font-serif)", color: "rgb(var(--warm-900))" },
  ...
  cardTitle: { fontSize: 20, fontWeight: 700, color: "rgb(var(--warm-900))", marginBottom: 8, fontFamily: "var(--font-serif)" },
  ...
  previewTitleInput: { width: "100%", border: "1.5px solid rgb(var(--warm-200))", borderRadius: 10, padding: "11px 14px", fontSize: 22, fontWeight: 700, color: "rgb(var(--warm-900))", fontFamily: "var(--font-serif)", marginBottom: 8, background: "white", outline: "none" },
