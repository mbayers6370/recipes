...
const MI: Record<string, React.CSSProperties> = {
  ...
  icon: { width: 30, height: 30, display: "flex", alignItems: "center", justifyContent: "center", color: "rgb(var(--terra-600))", flexShrink: 0, background: "rgb(var(--terra-50))", borderRadius: 999 },
...
const S: Record<string, React.CSSProperties> = {
  ...
  header: {
    ...
    boxShadow: "0 12px 30px rgba(71, 55, 46, 0.05)",
  },
  avatar: { flexShrink: 0, width: 78, height: 78, position: "relative", padding: 4, borderRadius: "50%", background: "linear-gradient(180deg, rgb(var(--terra-200)) 0%, rgb(var(--terra-50)) 100%)" },
  ...
  name: { fontSize: 24, fontWeight: 700, color: "rgb(var(--warm-900))", fontFamily: "var(--font-serif)", letterSpacing: "var(--tracking-display)" },
  username: { fontSize: 12, color: "rgb(var(--terra-700))", marginTop: 4, display: "inline-flex", alignItems: "center", justifyContent: "center", padding: "5px 10px", borderRadius: 999, background: "rgb(var(--terra-50))", fontWeight: 700, letterSpacing: "0.04em" },
  bio: { fontSize: 14, color: "rgb(var(--warm-600))", marginTop: 10, lineHeight: 1.55, maxWidth: 420 },
  statsRow: { display: "flex", gap: 24, background: "rgb(255, 252, 247)", borderRadius: 14, padding: "16px 20px", marginBottom: 24, border: "1px solid rgb(var(--warm-200))" },
  stat: { display: "flex", flexDirection: "column", alignItems: "center", gap: 4 },
  statNum: { fontSize: 28, lineHeight: 1, fontWeight: 700, color: "rgb(var(--warm-900))", fontFamily: "var(--font-serif)", letterSpacing: "var(--tracking-display)" },
  statLabel: { fontSize: 11, color: "rgb(var(--warm-500))", textTransform: "uppercase", letterSpacing: "0.06em", fontWeight: 700 },
  section: { marginBottom: 24 },
  sectionTitle: { fontSize: 12, fontWeight: 700, color: "rgb(var(--warm-500))", textTransform: "uppercase", letterSpacing: "0.06em", marginBottom: 10 },
  menuList: { background: "white", borderRadius: 14, padding: "0 16px", border: "1px solid rgb(var(--warm-200))", boxShadow: "0 8px 20px rgba(71, 55, 46, 0.03)" },
  installCard: { display: "flex", alignItems: "center", gap: 14, padding: "16px 0" },
  installIcon: { width: 34, height: 34, display: "flex", alignItems: "center", justifyContent: "center", color: "rgb(var(--terra-600))", flexShrink: 0, background: "rgb(var(--terra-50))", borderRadius: 999 },
  ...
  installBtn: { background: "rgb(var(--terra-600))", color: "white", border: "none", borderRadius: 12, padding: "10px 14px", fontSize: 13, fontWeight: 600, cursor: "pointer", flexShrink: 0 },
  ...
  logoutBtn: { width: "100%", background: "white", color: "rgb(var(--terra-600))", border: "1.5px solid rgb(var(--terra-200))", borderRadius: 14, padding: "14px", fontSize: 15, fontWeight: 600, cursor: "pointer", marginBottom: 16, boxShadow: "0 8px 20px rgba(71, 55, 46, 0.03)" },
