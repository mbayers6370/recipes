...
const S: Record<string, React.CSSProperties> = {
  ...
  card: { background: "white", borderRadius: 14, padding: "0 16px 16px", border: "1px solid rgb(var(--warm-100))", marginBottom: 28 },
  ...
  cardTitle: { fontSize: 16, fontWeight: 700, color: "rgb(var(--warm-900))" },
  cardSub: { fontSize: 12, color: "rgb(var(--warm-500))", marginTop: 4 },
  roleBadge: { display: "inline-flex", alignItems: "center", gap: 6, borderRadius: 999, background: "rgb(var(--terra-50))", color: "rgb(var(--terra-700))", padding: "6px 10px", fontSize: 12, fontWeight: 700 },
  ...
  input: { width: "100%", border: "1.5px solid rgb(var(--warm-200))", borderRadius: 10, padding: "11px 14px", fontSize: 14, background: "white", color: "rgb(var(--warm-900))", outline: "none" },
  primaryBtn: { background: "rgb(var(--terra-600))", color: "white", border: "none", borderRadius: 10, padding: "11px 16px", fontSize: 14, fontWeight: 600, cursor: "pointer" },
  primaryGhostBtn: { display: "inline-flex", alignItems: "center", gap: 8, background: "rgb(var(--terra-50))", color: "rgb(var(--terra-700))", border: "1px solid rgb(var(--terra-200))", borderRadius: 10, padding: "10px 12px", fontSize: 13, fontWeight: 700, cursor: "pointer" },
  secondaryBtn: { width: "100%", marginTop: 16, background: "white", color: "rgb(var(--warm-700))", border: "1px solid rgb(var(--warm-200))", borderRadius: 10, padding: "11px 16px", fontSize: 14, fontWeight: 600, cursor: "pointer" },
  error: { marginTop: 10, fontSize: 13, color: "rgb(var(--terra-700))" },
  sectionCard: { background: "white", border: "1px solid rgb(var(--warm-100))", borderRadius: 16, padding: "18px 16px", marginBottom: 28 },
  ...
  planSlot: { background: "white", border: "1px solid rgb(var(--warm-100))", borderRadius: 12, padding: "10px 10px 8px" },
  ...
  addMiniBtn: { display: "inline-flex", alignItems: "center", gap: 5, borderRadius: 999, border: "1px solid rgb(var(--warm-200))", background: "white", color: "rgb(var(--terra-600))", fontSize: 12, fontWeight: 700, padding: "5px 9px", cursor: "pointer" },
  ...
  ideaCard: { display: "flex", gap: 14, padding: "12px", border: "1px solid rgb(var(--warm-100))", borderRadius: 14, background: "rgb(var(--warm-50))", alignItems: "stretch" },
  ideaMedia: { width: 88, minWidth: 88, borderRadius: 12, overflow: "hidden", background: "rgb(var(--warm-100))", position: "relative" },
  ...
  ideaTitle: { fontSize: 15, fontWeight: 700, color: "rgb(var(--warm-900))", lineHeight: 1.4 },
  ideaMeta: { fontSize: 12, color: "rgb(var(--warm-500))", marginTop: 3 },
  voteRow: { display: "flex", flexWrap: "wrap" as const, gap: 8 },
  voteBtn: { display: "inline-flex", alignItems: "center", gap: 8, borderRadius: 999, border: "1px solid rgb(var(--warm-200))", background: "white", color: "rgb(var(--warm-700))", padding: "8px 11px", fontSize: 12, fontWeight: 700, cursor: "pointer" },
  ...
  recipeCard: { display: "flex", flexDirection: "column", textDecoration: "none", background: "white", border: "1px solid rgb(var(--warm-100))", borderRadius: 14, overflow: "hidden" },
  ...
  emptyWrap: { maxWidth: 520, margin: "72px auto 0", padding: "32px 24px", background: "white", border: "1px solid rgb(var(--warm-100))", borderRadius: 20, textAlign: "center" },
  ...
  emptyTitle: { fontSize: 24, fontWeight: 700, color: "rgb(var(--warm-900))", fontFamily: "var(--font-serif)", marginBottom: 8 },
  emptyText: { fontSize: 14, color: "rgb(var(--warm-600))", lineHeight: 1.6 },
  emptyHint: { fontSize: 13, color: "rgb(var(--warm-500))", marginTop: 6 },
  emptyRecipes: { background: "white", border: "1px solid rgb(var(--warm-100))", borderRadius: 18, padding: "24px 20px", textAlign: "center" },
  ...
  modal: { width: "100%", maxWidth: 520, background: "rgb(var(--warm-50))", borderRadius: 20, border: "1px solid rgb(var(--warm-100))", padding: 16, maxHeight: "80vh", overflowY: "auto" as const },
  ...
  modalTitle: { fontSize: 20, fontWeight: 700, color: "rgb(var(--warm-900))", fontFamily: "var(--font-serif)" },
  modalList: { display: "flex", flexDirection: "column", gap: 10 },
  noteBtn: { width: "100%", textAlign: "left", background: "white", border: "1px solid rgb(var(--warm-100))", borderRadius: 12, padding: "12px 14px", fontSize: 14, fontWeight: 600, color: "rgb(var(--warm-800))", cursor: "pointer" },
  modalRecipeBtn: { width: "100%", display: "flex", alignItems: "center", gap: 12, textAlign: "left", background: "white", border: "1px solid rgb(var(--warm-100))", borderRadius: 12, padding: "10px", cursor: "pointer" },
  modalRecipeThumb: { width: 48, height: 48, minWidth: 48, borderRadius: 10, overflow: "hidden", position: "relative", background: "rgb(var(--warm-100))" },
